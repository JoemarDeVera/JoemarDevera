...
- LinkedIn: [@joemargarcia](https://www.linkedin.com/in/joemargarcia/)
- Email: joemargarcia10@gmail.com

Recent Projects:  
- Helpdesk web app
- SQL-based Sales Analysis
- Excel-based Sales Performance Analysis
- Python-based E-commerce Sales Analysis
- SQL & Looker-based Corporate Layoffs Analysis
